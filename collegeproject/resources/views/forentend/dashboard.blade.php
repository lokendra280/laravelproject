...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  <div class="container">
    <a class="navbar-brand" href="#">Kath-City</a>
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav ">
        ...
        <li class="nav-item">
          <a class="nav-link" href="#">View Shipment</a>
        </li>
        <li class="nav-item ">
        <td><a class="nav-link" href="logout">Logout</a></td>
        </li>
      </ul>
    </div>
  </div>
...
<h1 style="text-align: center"> Create Shiping</h1>
{{-- sender information --}}
<form action="{{url('/')}}/senderinfo" method="POST">
  @csrf 
<div class="container">
  <div class="row">
    <div class="col-md-12">
    <div class="card">
        <div class="card-header">
          <h4 class="card-title" id="basic-layout-form">Sender Information</h4>
        </div>
